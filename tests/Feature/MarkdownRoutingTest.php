...
test('literal views take precendence over wildcard views', function () {
    ...
    expect(realpath(__DIR__.'/../tmp/views/profile.md'))->toEqual($resolved->path)
...
test('literal views may be in directories', function () {
    ...
    expect(realpath(__DIR__.'/../tmp/views/users/profile.md'))->toEqual($router->match(new Request, '/users/profile')->path);
});
...
test('wildcard views may be in directories', function () {
    ...
    expect(realpath(__DIR__.'/../tmp/views/users/[id].md'))->toEqual($resolved->path);
...
test('wildcard directories are properly handled', function () {
    ...
    expect(realpath(__DIR__.'/../tmp/views/flights/[id]/connections.md'))->toEqual($resolved->path);
...
test('nested wildcard directories are properly handled', function () {
    ...
    expect(realpath(__DIR__.'/../tmp/views/flights/[id]/connections/[connectionId]/map.md'))->toEqual($resolved->path)
